...
class LogBloc extends Bloc<LogEvent, LogState> {
  LogBloc({
    ...
    required Job upcomingJob,
    required Job recentJob,
    required User user,
  })  : _jobsRepository = jobsRepository,
        _job = upcomingJob,
        _recentJob = recentJob,
        _user = user,
        super(
          LogState(
            ...
            newTaskAction: '',
            tasks: upcomingJob.tasks,
            client: upcomingJob.client,
  ...
  Future<void> _onSubmitted(
    ...
    final output = _job.copyWith(logs: outputLogs, isCompleted: true);
